...
|---|---|---|
| `ts/` | @voxgig-sdk/image-transformation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/image-transformation-sdk \
      --repository voxgig-sdk/image-transformation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/image-transformation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/image-transformation-sdk --id=<id>` removes it.
