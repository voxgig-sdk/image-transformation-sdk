...
// ImageTransformation SDK audit feature
...
class ImageTransformationAuditFeature extends ImageTransformationBaseFeature
{
    ...
    private function _emit(ImageTransformationContext $ctx, string $outcome): void
    {
