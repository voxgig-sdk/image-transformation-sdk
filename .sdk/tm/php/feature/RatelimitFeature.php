...
// ImageTransformation SDK ratelimit feature
...
class ImageTransformationRatelimitFeature extends ImageTransformationBaseFeature
{
    ...
    private function _acquire(ImageTransformationContext $ctx): void
    {
    ...
    private function _track(ImageTransformationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
