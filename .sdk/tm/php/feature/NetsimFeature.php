...
// ImageTransformation SDK netsim feature
...
class ImageTransformationNetsimFeature extends ImageTransformationBaseFeature
{
    ...
    private function _simulate(ImageTransformationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ImageTransformationContext $ctx, array $applied): void
    {
        $client = $this->client;
