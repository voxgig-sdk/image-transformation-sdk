...
// ImageTransformation SDK streaming feature
...
class ImageTransformationStreamingFeature extends ImageTransformationBaseFeature
{
    ...
    private function _iterate(ImageTransformationResult $result): \Generator
    {
    ...
    private function _streamable(ImageTransformationContext $ctx): bool
    {
