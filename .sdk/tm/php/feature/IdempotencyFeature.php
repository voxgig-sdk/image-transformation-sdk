...
// ImageTransformation SDK idempotency feature
...
class ImageTransformationIdempotencyFeature extends ImageTransformationBaseFeature
{
    ...
    private function _mutating(ImageTransformationContext $ctx): bool
    {
