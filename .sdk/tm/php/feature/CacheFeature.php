...
// ImageTransformation SDK cache feature
...
class ImageTransformationCacheFeature extends ImageTransformationBaseFeature
{
    ...
    private function _through(ImageTransformationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
