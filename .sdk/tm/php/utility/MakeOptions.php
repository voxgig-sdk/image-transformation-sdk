...
// ImageTransformation SDK utility: make_options

class ImageTransformationMakeOptions
{
    ...
    public static function call(ImageTransformationContext $ctx): array
    {
        ...
        //
        // `ImageTransformationSchema::optspec()` is built from the model:
        ...
        $optspec = ImageTransformationSchema::optspec();
