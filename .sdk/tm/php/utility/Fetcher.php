...
// ImageTransformation SDK utility: fetcher

class ImageTransformationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ImageTransformationSDK/1.0)';
    ...
    public static function call(ImageTransformationContext $ctx, string $fullurl, array $fetchdef): array
    {
