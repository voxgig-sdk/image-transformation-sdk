...
// ImageTransformation SDK utility: result_basic

class ImageTransformationResultBasic
{
    public static function call(ImageTransformationContext $ctx): ?ImageTransformationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ImageTransformationError) ? $result->err->msg : (string)$result->err;
