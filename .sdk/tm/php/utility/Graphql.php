...
// ImageTransformation SDK utility: graphql
//
...
class ImageTransformationGraphql
{
    ...
    // equivalent.
    public static function body(ImageTransformationContext $ctx): mixed
    {
    ...
    public static function errors(ImageTransformationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
