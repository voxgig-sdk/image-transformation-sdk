# ImageTransformation SDK feature corpus test
#
...
def _client(kase):
    ...
    ImageTransformationSDK(...), not ImageTransformationSDK.test(...): the `test` feature is
    ...
    return ImageTransformationSDK(opts)
