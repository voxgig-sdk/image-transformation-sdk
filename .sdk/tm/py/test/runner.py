...
class ImageTransformationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ImageTransformationTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ImageTransformationTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ImageTransformationTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
