...
This API allows users to apply various transformations to images, enabling modifications such as filtering, resizing, and style transfer.

Learn more about Image Transformation API at [image.pollinations.ai/prompt/transform%20this%20image?model=kontext&image=](https://image.pollinations.ai/prompt/transform%20this%20image?model=kontext&image=).
...
// Load a specific imagetransformation (returns a ImageTransformation)
