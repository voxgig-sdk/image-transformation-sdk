...
#      offline in seeded test mode (ImageTransformationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ImageTransformation_sdk.rb")
  SDK_CLASS = "ImageTransformationSDK"
  ...
  SDK_BASE = "ImageTransformation_sdk"
