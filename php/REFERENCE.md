# ImageTransformation PHP SDK Reference

Complete API reference for the ImageTransformation PHP SDK.
...
#### `ImageTransformationSDK::test($testopts = null, $sdkopts = null)`
...
#### `make(): ImageTransformationEntity`
