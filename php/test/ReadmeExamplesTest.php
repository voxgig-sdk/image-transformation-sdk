...
// ImageTransformation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ImageTransformationSDK::test)
...
{
    private const SDK_CLASS = 'ImageTransformationSDK';
    ...
    private const SDK_BASE = 'imagetransformation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../imagetransformation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
