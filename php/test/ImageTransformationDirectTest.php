...
class ImageTransformationDirectTest extends TestCase
{
    public function test_direct_load_image_transformation(): void
    {
        $setup = image_transformation_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-image_transformation", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
