...
// ImageTransformation SDK utility type
...
class ImageTransformationUtility
{
    ...
    public static function copy(ImageTransformationUtility $src): ImageTransformationUtility
    {
        $u = new ImageTransformationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
