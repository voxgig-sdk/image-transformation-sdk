...
// ImageTransformation SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ImageTransformationMakeRequest
{
    public static function call(ImageTransformationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ImageTransformationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ImageTransformationResponse($fetched);
        } else {
