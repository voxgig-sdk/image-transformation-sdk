...
// ImageTransformation SDK paging feature
...
class ImageTransformationPagingFeature extends ImageTransformationBaseFeature
{
    ...
    private function _is_list(ImageTransformationContext $ctx): bool
    {
