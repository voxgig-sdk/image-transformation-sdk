...
// ImageTransformation SDK proxy feature
...
class ImageTransformationProxyFeature extends ImageTransformationBaseFeature
{
    ...
    public function init(ImageTransformationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ImageTransformationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
