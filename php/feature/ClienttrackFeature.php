...
// ImageTransformation SDK clienttrack feature
...
class ImageTransformationClienttrackFeature extends ImageTransformationBaseFeature
{
    ...
    public function PostConstruct(ImageTransformationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ImageTransformation-SDK';
