...
// ImageTransformation SDK debug feature
...
class ImageTransformationDebugFeature extends ImageTransformationBaseFeature
{
    ...
    private function _finish(ImageTransformationContext $ctx, bool $ok): void
    {
