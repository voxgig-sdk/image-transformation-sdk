...
// ImageTransformation SDK timeout feature
...
class ImageTransformationTimeoutFeature extends ImageTransformationBaseFeature
{
    ...
    private function _with_timeout(ImageTransformationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ImageTransformationContext $_ctx, float $ms): void
    {
        $client = $this->client;
