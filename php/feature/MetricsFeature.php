...
// ImageTransformation SDK metrics feature
...
class ImageTransformationMetricsFeature extends ImageTransformationBaseFeature
{
    ...
    private function _record(ImageTransformationContext $ctx, bool $ok): void
    {
