...
// ImageTransformation SDK rbac feature
...
class ImageTransformationRbacFeature extends ImageTransformationBaseFeature
{
    ...
    private function _required(ImageTransformationContext $ctx): ?string
    {
    ...
    private function _reject(ImageTransformationContext $ctx, string $required): void
    {
    ...
    private function _track(ImageTransformationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
