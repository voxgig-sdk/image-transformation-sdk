...
// ImageTransformation SDK telemetry feature
...
class ImageTransformationTelemetryFeature extends ImageTransformationBaseFeature
{
    ...
    private function _close(ImageTransformationContext $ctx, bool $ok): void
    {
