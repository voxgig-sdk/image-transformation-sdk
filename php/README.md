...
The PHP SDK for the ImageTransformation API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->ImageTransformation(null)->load(["id" => "example_id"], null);
