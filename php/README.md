# ImageTransformation PHP SDK



The PHP SDK for the ImageTransformation API — an entity-oriented client using PHP conventions.
...
try {
    ...
    print_r($imagetransformation->data_get());
} catch (\Throwable $err) {
...
```
php/
├── imagetransformation_sdk.php          -- Main SDK class
...
The main class (`imagetransformation_sdk.php`) exports the SDK class
