...
from imagetransformation_sdk.imagetransformation_types import (
    ImageTransformation,
...
class ImageTransformationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ImageTransformationEntity(self._client, opts)
    ...
    def data_get(self) -> ImageTransformation:
    ...
    def match_get(self) -> ImageTransformation:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ImageTransformation:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ImageTransformation().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
