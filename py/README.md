# ImageTransformation Python SDK



The Python SDK for the ImageTransformation API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.ImageTransformation()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/image-transformation-sdk/releases)) or
...
```
py/
├── imagetransformation_sdk.py         -- Main SDK module
