# ImageTransformation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ImageTransformationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ImageTransformationSDK(...) and ImageTransformationSDK.test(...) become
#      ImageTransformationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "imagetransformation_sdk"
_SDK_CLASS = "ImageTransformationSDK"
