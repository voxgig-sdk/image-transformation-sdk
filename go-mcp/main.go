// Command ImageTransformation-mcp is an MCP server exposing the ImageTransformation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ImageTransformation_list  — list records of an entity
//	ImageTransformation_load  — load a single record of an entity
//
