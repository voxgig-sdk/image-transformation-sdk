...
type Args struct {
	Entity string         `json:"entity" jsonschema:"image_transformation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ImageTransformationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "image-transformation_list",
		Description: "List records from ImageTransformation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "image-transformation_load",
		Description: "Load a single record from ImageTransformation. " +
...
func runOp(client *sdk.ImageTransformationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ImageTransformationSDK, name string) (sdk.ImageTransformationEntity, error) {
	switch strings.ToLower(name) {
	case "image_transformation":
		return client.ImageTransformation(nil), nil
