...
func registerSDKWords(r *eng.Registry, client *sdk.ImageTransformationSDK) {
...
func runOp(client *sdk.ImageTransformationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
