...
AQL-driven command-line client **and** interactive REPL for the ImageTransformation
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `image_transformation`).
