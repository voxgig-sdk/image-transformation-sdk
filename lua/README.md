...
The Lua SDK for the ImageTransformation API. Provides an entity-oriented interface using Lua conventions.
...
```lua
local result, err = client:ImageTransformation(nil):load({ id = "example_id" }, nil)
