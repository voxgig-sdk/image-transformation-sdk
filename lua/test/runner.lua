...
function runner.env_override(m)
  local live = runner.getenv("IMAGETRANSFORMATION_TEST_LIVE")
  local override = runner.getenv("IMAGETRANSFORMATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IMAGETRANSFORMATION_TEST_EXPLAIN")
