...
function runner.env_override(m)
  local live = runner.getenv("IMAGE_TRANSFORMATION_TEST_LIVE")
  local override = runner.getenv("IMAGE_TRANSFORMATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IMAGE_TRANSFORMATION_TEST_EXPLAIN")
