...
describe("ImageTransformationDirect", function()
  it("should direct-load-image_transformation", function()
    local setup = image_transformation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-image_transformation", setup.live and "live" or "unit")
...
function image_transformation_direct_setup(mockres)
