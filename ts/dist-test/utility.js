...
function envOverride(m) {
    if ('TRUE' === process.env.IMAGE_TRANSFORMATION_TEST_LIVE ||
        'TRUE' === process.env.IMAGE_TRANSFORMATION_TEST_OVERRIDE) {
    ...
    m.IMAGE_TRANSFORMATION_TEST_EXPLAIN = process.env.IMAGE_TRANSFORMATION_TEST_EXPLAIN || m.IMAGE_TRANSFORMATION_TEST_EXPLAIN;
    return m;
}
