...
(0, node_test_1.describe)('ImageTransformationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ImageTransformationSDK({
    ...
    (0, node_test_1.test)('direct-load-image_transformation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-image_transformation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IMAGE_TRANSFORMATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ImageTransformationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IMAGE_TRANSFORMATION_TEST_IMAGE_TRANSFORMATION_ENTID'];
    ...
    const client = new __1.ImageTransformationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ImageTransformationDirect.test.js.map