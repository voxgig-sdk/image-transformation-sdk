...
class ImageTransformationEntity extends ImageTransformationEntityBase<ImageTransformation> {
  ...
  make(this: ImageTransformationEntity) {
    return new ImageTransformationEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: ImageTransformationLoadMatch, ctrl?: Control): Promise<ImageTransformationEntity> {
