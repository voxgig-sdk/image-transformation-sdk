...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.IMAGETRANSFORMATION_TEST_LIVE ||
    'TRUE' === process.env.IMAGETRANSFORMATION_TEST_OVERRIDE
  ) {
  ...
  m.IMAGETRANSFORMATION_TEST_EXPLAIN = process.env.IMAGETRANSFORMATION_TEST_EXPLAIN || m.IMAGETRANSFORMATION_TEST_EXPLAIN
